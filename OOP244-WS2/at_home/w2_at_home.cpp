...
int main() {
    ...
    Kingdom *pNewKingdom = nullptr;
    pNewKingdom = new Kingdom[count + 1];
    ...
    cout << "==========\n"
         << "Input data\n"
         << "==========\n"
         << "Kingdom #3: " << endl << "Enter the name of the Kingdom: ";

    // TODO: accept input for the new element in the array
    cin >> pNewKingdom[count].m_name;
    cout << "Enter the number of people living in " << pNewKingdom[count].m_name << ": ";
    cin >> pNewKingdom[count].m_population;
    count++;
    cout << "==========\n" << endl;

    // testing that the overload of "display(...)" works
    display(pNewKingdom, count);
    cout << endl;
